...
{
    private const int AIDECK_PORT = 25555;
    ...
    public void connect_to_aideck()
    {
        ...
        TMP_InputField aideck_ip_field = GameObject.Find("AIdeckIPField").GetComponent<TMP_InputField>();

        Socket socket = connect_socket(aideck_ip_field.text, AIDECK_PORT);
        //Socket socket = connect_socket("192.168.86.132", AIDECK_PORT);
